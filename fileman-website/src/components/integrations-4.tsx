import { TypescriptIcon, TauriIcon, ViteIcon, RustIcon, ReactIcon } from '@/components/logos'
import { cn } from '@/lib/utils'
import { LogoIcon } from '@/components/logo'
import { Button } from '@/components/ui/button'
import Link from 'next/link'
import ShadcnIcon from './logos/ShadcnIcon'
                ...
                <div className="mx-auto max-w-5xl px-6">
                    ...
                    <div className="mx-auto mt-12 max-w-lg space-y-6 text-center">
                        ...
                        <p className="text-muted-foreground">
                            A stack that is performance friendly using Rust as the backend, Tauri for desktop apps, and Vite for blazing fast builds.
                        </p>
                        ...
                        <Button
                            ...
                            size="sm"
                            asChild>
                            <Link href="https://github.com/logikdose/Fileman" target="_blank">Browse Project</Link>
                        </Button>
                    </div>
                </div>
            </div>
